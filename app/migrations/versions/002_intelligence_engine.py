...
def upgrade() -> None:
    ...
    op.create_index("ix_episodic_task_outcome",
                    "episodic_memories", ["task_type", "outcome"])
    op.create_index("ix_episodic_workspace_created",
                    "episodic_memories", ["workspace_id", "created_at"])
    ...
    op.create_table(
        ...
        sa.Column("trigger_patterns", JSONB(), nullable=False),
        ...
        sa.Column("auto_discovered", sa.Boolean(), nullable=False,
                  server_default="true"),
        sa.Column("source_memory_ids", JSONB(), nullable=True),
    ...
    op.create_index("ix_skills_category_confidence",
                    "skills", ["category", "confidence_score"])
    ...
    op.create_table(
        ...
        sa.Column("tasks_analyzed", sa.Integer(), nullable=False,
                  server_default="0"),
        sa.Column("new_skills_discovered", sa.Integer(), nullable=False,
                  server_default="0"),
