...
class TestSubAgent:
    @pytest.mark.asyncio
    async def test_builtin_agents_defined(self):
    ...
    def test_route_to_sub_agent(self):
...
class TestRulesSystem:
    ...
    def test_get_project_rules(self, tmp_path):
        agents_md = tmp_path / "AGENTS.md"
    ...
    def test_create_default_agents_md(self, tmp_path):
        rules = RuleSystem(str(tmp_path))
